...
<?php
            ...
            case 'smtp_settings':
                ...
                case 'manual_deposit_withdraw':
                    ...
                    $result = $mysqli->query("SELECT * FROM deposits WHERE withdrawn = 'No' AND status = 'Completed' ORDER BY created_at DESC");
                    ...
                    case 'manual_withdraw':
                        ...
                        // Lekérdezzük a függőben lévő kifizetéseket, és csatlakoztatjuk az `users` táblát az `username` lekéréséhez
                        $stmt = $mysqli->prepare("
                            SELECT w.id, w.amount, w.requested_at, u.username 
                            FROM withdrawals w 
